...
func processRead(msg *Msg) *Msg {
	...
	if fi := fs.dir[msg.Filename]; fi != nil {
		...
		return &Msg{Kind: 'F', ClientID:msg.ClientID, ServerID:msg.ServerID} // file not found
	}
}
...
func processCas(msg *Msg) *Msg {
	...
	if fi := fs.dir[msg.Filename]; fi != nil {
		if msg.Version != fi.version {
			return &Msg{Kind: 'V', Version: fi.version, ClientID: msg.ClientID, ServerID:msg.ServerID}
		}
	}
	return internalWrite(msg)
}
